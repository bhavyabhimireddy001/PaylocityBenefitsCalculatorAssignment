...
namespace Api.Repository
{
    public class PayrollRepository : IPayrollRepository
    {
        public string AddEmployeeWorkingHours(List<EmployeeHoursDTO> employeeHours)
        {
            ...
            {
                // Iterates through each EmployeeHoursDTO object provided.
                foreach (var employeeHoursDTO in employeeHours)
                {
                    ...
                    {
                        // Adds a new EmployeePayment record with the provided hours and links it to the found pay period schedule.
        ...
        {
            // Determines the first pay period's start date for the given year.
            DateTime startDate = new DateTime(year, 1, 1);

            // Adjusts the start date to the first Friday of the year, assuming pay periods start on a Friday.
        ...
        public List<EmployeeHoursDTO> GetEmployeeDetailsForProcessingPayroll(DateTime payPeriodStartDate, DateTime payPeriodEndDate)
        {
            ...
            using (var _context = new PaylocityBenefitsContext())
            {
                // Finds the pay period schedule ID for the provided start and end dates.
                ...
                // Fetches employee IDs associated with the found pay period schedule.
                ...
                // Retrieves details for each employee and constructs EmployeeHoursDTO objects.
        ...
        public void UpdatePayrollDataInDB(List<EmployeePaymentDTO> employeePaymentsDTO, DateTime payPeriodStartDate, DateTime payPeriodEndDate)
        {
            using (var _context = new PaylocityBenefitsContext())
            {
                // Identifies the pay period schedule ID based on provided dates.
                int payPeriodScheduleId = _context.PayPeriodSchedules
                ...
                // marks the pay period as executed if needed.
